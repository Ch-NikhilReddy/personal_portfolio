      ...
      <div className="container">
        <header className="resume-header">
          ...
          <div className="contact-info">
            ...
            <span>
              ...
              >
                chittepu-nikhil-reddy-3a78172b6
              </a>
            </span>
            <span>
              📄{' '}
                ...
                href="/pdf/Resume.pdf"
                download="Nikhil_Reddy_Resume.pdf"
        ...
        <main className="resume-main">
          <section className="resume-section">
            ...
            <p>
              Motivated B.Tech IT student with hands-on experience in full-stack web development.
              Passionate about building real-world applications using modern web technologies and
              eager to apply technical skills in software development roles.
            </p>
          </section>
          ...
          <section className="resume-section">
            ...
            <div className="project-item">
              ...
              <p>
                Developed a web platform for citizens to report civic issues such as potholes,
                garbage, and water leakage.
              </p>
